...
const EmployeeCard: React.FC<EmployeeCardProps> = ({
  ...
  return (
    <div
      className={`w-full rounded-[23px] bg-white dark:bg-zinc-900 shadow-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-zinc-300 dark:hover:border-zinc-700 ${onSelect ? 'cursor-pointer' : ''
      ...
      <div className="relative p-6 pt-0">
        ...
        <div className="absolute left-6 -top-12">
          <div className="relative">
            <div
              className={`w-24 h-24 rounded-full border-4 border-white dark:border-zinc-900 shadow-xl overflow-hidden ${employee.profilePicture || employee.profilePictureUrl
                ? ''
        ...
        <div className="text-left pt-14">
          ...
          <div className="mt-6 pt-4 border-t border-zinc-200 dark:border-zinc-700 space-y-2">
            ...
            {onViewDocuments && employee.documents && employee.documents.length > 0 && (
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  onViewDocuments(employee);
                }}
                className="w-full px-4 py-2.5 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 font-medium transition-all duration-200 text-sm flex items-center justify-center gap-2"
              >
