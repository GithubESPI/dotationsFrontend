...
const SyncResultModal: React.FC<SyncResultModalProps> = ({
    ...
    return (
        <Modal
            ...
            title="Résultat de la synchronisation Jira"
            size="md"
            ...
            {isLoading ? (
                <div className="text-center py-8">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">
                        Veuillez patienter pendant la synchronisation des équipements depuis Jira Asset
                    </p>
                </div>
            ) : error ? (
                ...
                <div className="space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-zinc-600 dark:text-zinc-400">
                            Les équipements ont été synchronisés depuis Jira Asset
                        </p>
                    </div>

                    {/* Résultats */}
                    <div className="space-y-4">
                        {/* Équipements synchronisés (créés + mis à jour) */}
                                ...
                                <div>
                                    ...
                                    <div className="flex items-baseline gap-2">
                                        <p className="text-2xl font-bold text-black dark:text-zinc-50">
                                            {(result.created + result.updated).toLocaleString()}
                                        </p>
                                        <span className="text-xs text-zinc-500">
                                            ({result.created} créés, {result.updated} maj)
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        {result.skipped !== undefined && result.skipped > 0 && (
                            <div className="flex items-center justify-between p-4 rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                                ...
                                <p className="text-xs text-zinc-500 dark:text-zinc-500 max-w-xs text-right">
                                    Éléments sans numéro de série ou incomplets
                                </p>
                            </div>
                        )}
                    </div>
